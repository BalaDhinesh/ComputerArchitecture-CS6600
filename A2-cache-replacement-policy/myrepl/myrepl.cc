...
bool policy = false;
uint32_t lru_counter = 1400;
uint32_t hawkeye_counter = 1400;
...
OPTgen optgen_occup_vector[LLC_SETS];   //64 vectors, 128 entries each
...
{
    cout << "Initialize Hawkeye1 replacement policy state" << endl;
